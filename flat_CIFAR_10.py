...
parser.add_argument('--bits', default='6,48,96', type=str,
...
def adsh_algo(code_lengths):
    ...
    for iter in range(max_iter):
        ...
        if iter % 10 == 0:
            ...
            logger.info('[Evaluation: TopkPre: %.4f]', topkpre)
            logger.info('[2# Evaluation: TopkPre: %.4f]', topkpre1)
            logger.info('[3# Evaluation: TopkPre: %.4f]', topkpre2)
            record['rB'] = rB
            record['qB'] = qB
